...
<body class="bg-red-50 text-slate-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <img src="{{ asset('images/megawide.png') }}"
                     class="w-28 sm:w-36 md:w-44 h-auto"
                     alt="Megawide Logo">

                <span class="font-bold text-lg md:text-xl text-red-600">
                    AP Portal
                </span>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-2">
                ...
                <a href="{{ route('register.employee') }}"
                   class="px-4 py-2 bg-white border border-red-600 text-red-600 rounded-lg text-sm hover:bg-red-50 transition">
                    Employee Register
                </a>
    ...
    <!-- HERO SECTION -->
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="#about"
               class="px-6 py-3 border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition">
                Learn More
            </a>
    ...
    <!-- ABOUT SECTION -->
    <section id="about" class="bg-white py-12 md:py-20 border-t border-red-100">

        <div class="max-w-6xl mx-auto px-4 sm:px-6 text-center">

            <h2 class="text-2xl md:text-3xl font-bold mb-6 text-red-600">
                About Us
            </h2>
    ...
    <!-- FEATURES SECTION -->
    <section class="py-12 md:py-20 bg-red-50">

        <div class="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-6">

            <div class="bg-white p-6 rounded-xl shadow border border-red-100 hover:shadow-lg transition">
    ...
    <!-- CONTACT SECTION -->
    <section id="contact" class="bg-white py-12 md:py-20 border-t border-red-100">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div class="max-w-md w-full mx-auto text-left space-y-4">

                <input type="text"
                       placeholder="Your Name"
                       class="w-full border border-red-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-red-300 focus:outline-none">
                ...
                <textarea
                    ...
                    class="w-full border border-red-200 rounded-lg px-4 py-2 h-32 focus:ring-2 focus:ring-red-300 focus:outline-none"></textarea>
    ...
    <!-- FOOTER -->
    <footer class="bg-red-900 text-white py-6 text-center text-sm px-4">
