...
<head>
    ...
    <title>Create Employee Account - AP Portal</title>
...
<body class="bg-red-50 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 border border-red-100">
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-red-600">Create Employee Account</h1>
            <p class="text-sm text-slate-500">Register an employee for AP Portal access</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('register.employee.submit') }}" method="POST" class="space-y-4">
            @csrf
